...
var Foreman = [
  [
    Machine('11', 'Washer', 'F2'),
    // {'id': 11, 'type': 'Washer', 'floor': 'F2'},
    // {'id': 11, 'type': 'Dryer', 'floor': 'F2'},
  ],
  [
    Machine('12', 'Washer', 'F3'),
    Machine('13', 'Washer', 'F3'),
  ...
  [
    Machine('14', 'Washer', 'F4'),
    Machine('15', 'Washer', 'F4'),
  ...
  [
    Machine('16', 'Washer', 'F5'),
    Machine('17', 'Washer', 'F5'),
  ...
  [
    Machine('18', 'Washer', 'F6'),
    Machine('19', 'Washer', 'F6'),
  ...
  [
    Machine('20', 'Washer', 'F7'),
    Machine('21', 'Washer', 'F7'),
...
var Conard = [
  [
    Machine('22', 'Washer', 'C1'),
    Machine('23', 'Washer', 'C1'),
    Machine('24', 'Washer', 'C1'),
